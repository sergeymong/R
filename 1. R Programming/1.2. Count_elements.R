...
count_elements <- function(x) {
  # считает количество повторений каждого элемента в векторе, возвращая матрицу
  # c отсортированными по возрастанию значениями
  l1 <- unique(sort(x))
...
# тестовый вектор большой длины
x <- sample(1:10e10, 10e3, replace = TRUE)

benchmark(count_elements(x))
